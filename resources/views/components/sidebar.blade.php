...
<aside class="w-64 bg-gradient-to-b from-blue-900 to-blue-800 text-white flex-shrink-0 relative flex flex-col h-screen">
    ...
    <nav class="flex-1 overflow-y-auto py-4" aria-label="Main navigation">
        <ul class="space-y-1 px-3">
            ...
            <li>
                ...
                >
                    <svg class="w-5 h-5 mr-3 {{ request()->routeIs('dashboard') ? 'text-white' : 'text-blue-300 group-hover:text-white' }} transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                ...
                >
                    <svg class="w-5 h-5 mr-3 {{ request()->routeIs('reports.adpSummary') ? 'text-white' : 'text-blue-300 group-hover:text-white' }} transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                ...
                >
                    <svg class="w-5 h-5 mr-3 {{ request()->routeIs('reports.sdgSummary') ? 'text-white' : 'text-blue-300 group-hover:text-white' }} transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                ...
                >
                    <svg class="w-5 h-5 mr-3 {{ request()->routeIs('mappings.*') ? 'text-white' : 'text-blue-300 group-hover:text-white' }} transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="border-t border-blue-700/50 p-4 bg-blue-950/50">
        <div class="flex items-center space-x-3">
            {{-- User Avatar --}}
            <div class="relative">
                <div class="w-10 h-10 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center ring-2 ring-blue-500/30">
        ...
        <div id="userMenu" class="hidden mt-2 py-1 bg-blue-900 rounded-lg shadow-xl border border-blue-700/50">
            <a href="#" class="flex items-center px-3 py-2 text-sm text-blue-100 hover:bg-white/5 transition-colors">
            ...
            <a href="#" class="flex items-center px-3 py-2 text-sm text-red-300 hover:bg-red-500/10 transition-colors">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
